...
var Slider = function (_a) {
    var children = _a.children, velocity = _a.velocity, scatterRandomly = _a.scatterRandomly, minScale = _a.minScale, maxScale = _a.maxScale, motion = _a.motion, motionDuration = _a.motionDuration, motionRadius = _a.motionRadius, resetAfterTries = _a.resetAfterTries, onFinish = _a.onFinish;
    ...
    return (react_1.default.createElement("div", { className: "container", ref: containerRef },
        react_1.default.createElement("div", { className: "marquee", ref: marqueeRef, style: { animationDuration: animationDuration + "s" } }, children
            .filter(function (child, index) {
            return scatterRandomly ? childrenPosition[index] !== undefined : true;
        })
            ...
            return (react_1.default.createElement(Child_1.default, __assign({ key: index }, pos, { scatterRandomly: scatterRandomly, motion: motion, motionDuration: motionDuration, motionRadius: motionRadius }), child));
        })),
        react_1.default.createElement("div", { className: "marquee repeater", style: { animationDuration: animationDuration + "s" } }, children
            .filter(function (child, index) {
            return scatterRandomly ? childrenPosition[index] !== undefined : true;
        })
            .map(function (child, index) {
