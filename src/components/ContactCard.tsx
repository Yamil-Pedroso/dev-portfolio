  ...
  return (
    <div className="container" style={{ color: 'black', margin: '5rem auto' }}>
      <div className="flex justify-around max-md:items-center max-sm:justify-center max-md:flex-col max-lg:flex-col">
        <div className="w-[25rem] h-[17rem] max-md:w-[20rem] max-sm:w-[16rem] max-md:items-center max-md:h-[8rem] border-black border-[5px] shadow-card flex flex-col justify-center px-8 relative mx-8 max-lg:mb-20 max-sm:mb-2">
          <div className="">
            <div
