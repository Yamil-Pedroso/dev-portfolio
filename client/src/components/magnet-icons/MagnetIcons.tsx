...
import { pcOne, pcTwo, pcThree, pcFour } from "../../assets/index";
  ...
  return (
      <main className={styles.main}>
        <div className={styles.imgWrapper}>
          <div>
            <div className={styles.box}>
              <img src={pcOne} alt="pc" />
            </div>
            <div className={styles.box}>
              <img src={pcTwo} alt="pc" />
            </div>
          </div>
          <div>
            <div className={styles.box}>
              <img src={pcThree} alt="pc" />
            </div>
            <div className={styles.box}>
              <img src={pcFour} alt="pc" />
            </div>
          </div>
        </div>
        ...
        <motion.div
          ...
          animate={isPaused[index] ? {} : positions[index]}
          transition={{ duration: 8, repeat: Infinity, repeatType: "reverse" }}
          style={{ position: "absolute", zIndex: 999, color: "#0099ff", cursor: "grab" }}
          onMouseEnter={() => handleMouseEnter(index)}
          onMouseLeave={() => handleMouseLeave(index)}
        >
          <div className="magnet-icon__code">{code}</div>
        </motion.div>
      ))}*/}
